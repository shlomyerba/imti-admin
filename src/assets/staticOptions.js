...
export const importances = [{ id: "CRITICAL", name: "קריטית" }, { id: "HIGH", name: "גבוהה" },
{ id: "MEDIUM", name: "רגילה" }, { id: "LOW", name: "נמוכה" },];

export const orientations = [{ id: "LEFT", name: 'שמאל' }, { id: "RIGHT", name: 'ימין' },
{ id: "CENTER", name: 'מרכז' }];
